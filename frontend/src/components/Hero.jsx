      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center w-full relative z-10">
        ...
        >
          <div 
            ...
            data-cursor="Play"
            className="absolute inset-0 bg-gradient-to-tr from-purple-100 to-indigo-50 rounded-2xl transform rotate-3 scale-95 -z-10 cursor-none shadow-lg border border-purple-100 overflow-hidden"
          >
